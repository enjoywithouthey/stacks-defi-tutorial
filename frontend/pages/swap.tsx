...
export default function SwapPage() {
  ...
  const stxToTokenSwap = async (stxAmount: number) => {
    ...
    // In the original code stxAmount = microstacks.  Not sure why
...
// Contract POST CONDITION FAILS with any STX-TO-TOKEN swap over 100 and I think it's due to liquidity issues, but not sure.